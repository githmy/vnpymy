    ...
    DayGrid.mixin({
        ...
        fgSegHtml: function (seg, disableResizing) {
            ...
            return '<a class="' + classes.join(' ') + '"' +
                ...
                (skinCss ?
                        // ' style="' + skinCss + ';margin-bottom: 0.2em;width: 10em;margin-left:auto;margin-right:auto;"' :
                        ' style="' + skinCss + ';margin-bottom: 0.2em;"' :
                        ''
                ) +
                '>' +
                ...
                // '</a><a><div style="height: 1em;color: #ffffff"></div></a>';
                '</a>';
        },
    ...
    TimeGrid.mixin({
        ...
        fgSegHtml: function (seg, disableResizing) {
            ...
            return '<div class="' + classes.join(' ') + '"' +
                ...
                '<div style="height: 1em;color: #ffffff"></div></a>';
            // '</a>';
        },
